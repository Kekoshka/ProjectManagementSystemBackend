...
namespace ProjectManagementSystemBackend.Services
{
    public class TaskService : ITaskService
    {
        ...
        public async Task<IEnumerable<TaskDTO>> GetAsync(int baseBoadrId, CancellationToken cancellationToken)
        {
            var tasks = await _context.Tasks
                .Include(t => t.BoardStatus)
                .Where(t => t.BoardStatus.BaseBoardId == baseBoadrId)
        ...
        public async Task<TaskDTO> PostAsync(TaskDTO task, int userId, CancellationToken cancellationToken)
        {
            ...
            Models.Task newTask = task.Adapt<Models.Task>();
        ...
        public async Task UpdateAsync(TaskDTO updatedTask, int userId, CancellationToken cancellationToken)
        {
            ...
            var oldTask = await _context.Tasks.FindAsync(updatedTask.Id, cancellationToken);
